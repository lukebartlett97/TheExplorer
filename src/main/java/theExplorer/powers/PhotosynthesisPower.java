...
public class PhotosynthesisPower extends ExplorerPower {
    public AbstractCreature source;

    public static final String POWER_ID = ExplorerMod.makeID(PhotosynthesisPower.class.getSimpleName());
    ...
    public PhotosynthesisPower(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
