package theExplorer.powers.defaultMod;
...
import static theExplorer.ExplorerMod.makePowerPath;
...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = ExplorerMod.makeID("CommonPower");
