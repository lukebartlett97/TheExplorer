...
public class EnergisedPower extends ExplorerPower {

    public AbstractCreature source;

    public static final String POWER_ID = ExplorerMod.makeID(EnergisedPower.class.getSimpleName());
    ...
    public EnergisedPower(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
