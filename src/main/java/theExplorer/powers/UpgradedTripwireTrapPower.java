...
public class UpgradedTripwireTrapPower extends ExplorerPower {
    public AbstractCreature source;

    public static final String POWER_ID = ExplorerMod.makeID(UpgradedTripwireTrapPower.class.getSimpleName());
    ...
    public UpgradedTripwireTrapPower(final AbstractCreature owner, final AbstractCreature source, int amount, int damage) {
        name = NAME;
        ID = POWER_ID;
