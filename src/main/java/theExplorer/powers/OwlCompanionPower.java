...
public class OwlCompanionPower extends CompanionPower {
    public AbstractCreature source;

    public static final String POWER_ID = ExplorerMod.makeID(OwlCompanionPower.class.getSimpleName());
    ...
    public OwlCompanionPower(final AbstractCreature owner, final AbstractCreature source) {
    ...
    public void act() {
        super.act();
        addToTop(new DrawCardAction(getEvolutionNumber()));
    }
