package theExplorer.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import theExplorer.cards.AbstractDefaultCard;

import static theExplorer.ExplorerMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "theExplorer:" (or, your id) before the name.
    }
