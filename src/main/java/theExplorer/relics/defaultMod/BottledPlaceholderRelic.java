package theExplorer.relics.defaultMod;
...
import theExplorer.patches.relics.BottledPlaceholderField;
import theExplorer.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theExplorer.ExplorerMod.makeRelicOutlinePath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = ExplorerMod.makeID("BottledPlaceholderRelic");
