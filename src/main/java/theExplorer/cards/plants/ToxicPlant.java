...
public class ToxicPlant extends PlantCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(ToxicPlant.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    //TODO: Add real art.
    public static final String IMG = makeCardPath("ToxicPlant.png");
