...
public class Fertilizer extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(Fertilizer.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        upgradeAllInGroup(p.hand);
        if (upgraded) {
            upgradeAllInGroup(p.discardPile);
            upgradeAllInGroup(p.drawPile);
            upgradeAllInGroup(p.exhaustPile);
        }
    }

    private void upgradeAllInGroup(CardGroup cardGroup) {
