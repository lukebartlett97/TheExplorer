...
public class Stun extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(Stun.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    //TODO: Add real art.
    public static final String IMG = makeCardPath("Stun.png");
