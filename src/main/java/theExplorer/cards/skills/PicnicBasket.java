...
public class PicnicBasket extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(PicnicBasket.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    //TODO: Add real art.
    public static final String IMG = makeCardPath("PicnicBasket.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ArrayList<CustomCard> plants = PlantService.getAllPlants(upgraded);
        for (CustomCard plant : plants) {
