...
import theExplorer.actions.StockpileAction;
...
public class Stockpile extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(Stockpile.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new StockpileAction(upgraded));
    }
