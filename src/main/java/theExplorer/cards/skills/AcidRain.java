...
public class AcidRain extends CustomCard {
    ...
    public static final String ID = ExplorerMod.makeID(AcidRain.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for (AbstractMonster monster : AbstractDungeon.getCurrRoom().monsters.monsters) {
            addToBot(new ApplyPowerAction(monster, p, new PoisonPower(monster, p, this.magicNumber), this.magicNumber, AbstractGameAction.AttackEffect.POISON));
        }
        addToBot(new ApplyPowerAction(p, p, new PoisonPower(p, p, this.magicNumber), this.magicNumber, AbstractGameAction.AttackEffect.POISON));
    }
