...
public class CorruptedBlade extends CustomCard implements UnblockedEventListener {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(CorruptedBlade.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new UnblockedAction(p, m, this));
    }
