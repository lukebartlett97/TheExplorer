...
public class Trip extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(Trip.class.getSimpleName());
    ...
    private static final int UPG_PLUS_WEAK = 1;
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPG_PLUS_WEAK);
