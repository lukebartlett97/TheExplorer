...
public class PiercingShot extends CustomCard implements UnblockedEventListener {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(PiercingShot.class.getSimpleName());
