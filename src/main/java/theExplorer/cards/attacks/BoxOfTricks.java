...
public class BoxOfTricks extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(BoxOfTricks.class.getSimpleName());
    ...
    private ArrayList<CardType> typesPlayed = new ArrayList<>();
