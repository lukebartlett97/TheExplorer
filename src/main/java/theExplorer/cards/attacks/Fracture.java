...
public class Fracture extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(Fracture.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new FractureAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
    }
