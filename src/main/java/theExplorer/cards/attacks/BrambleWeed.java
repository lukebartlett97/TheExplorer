...
public class BrambleWeed extends CustomCard implements UnblockedEventListener {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(BrambleWeed.class.getSimpleName());
    ...
    @Override
    public void unblocked(AbstractPlayer p, AbstractMonster m, int health) {
        addToBot(new MakeTempCardInHandAction(PlantService.getRandomPlant()));
    }
}
