...
public class HatToss extends CustomCard {

    // TEXT DECLARATION

    public static final String ID = ExplorerMod.makeID(HatToss.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (this.damage > 0) {
            ...
            addToTop(new HatTossAction(randomMonster, this.damage - 2));

            if (randomMonster.currentHealth > 0) {
                addToTop(new DamageAction(randomMonster, new DamageInfo(AbstractDungeon.player, this.damage), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
