...
public class TigerCompanion extends CustomCard implements StartupCard {
    ...
    public static final String ID = ExplorerMod.makeID(TigerCompanion.class.getSimpleName());
    ...
    public boolean atBattleStartPreDraw() {
        ...
        CompanionService.setCompanion(TigerCompanionPower.class.getName());
        return true;
    }
}
