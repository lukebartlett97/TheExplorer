...
import theExplorer.powers.PhotosynthesisPower;
...
public class Photosynthesis extends CustomCard {
    ...
    public static final String ID = ExplorerMod.makeID(Photosynthesis.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new PhotosynthesisPower(p, p, upgraded ? 2 : 1), 1));
    }
