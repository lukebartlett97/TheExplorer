...
public class TurtleCompanion extends CustomCard implements StartupCard {
    ...
    public static final String ID = ExplorerMod.makeID(TurtleCompanion.class.getSimpleName());
    ...
    public boolean atBattleStartPreDraw() {
        ...
        CompanionService.setCompanion(TurtleCompanionPower.class.getName());
        return true;
    }
}
