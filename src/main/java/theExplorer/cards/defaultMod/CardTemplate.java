...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = ExplorerMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = ExplorerMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("Atk_Beta.png");// "public static final String IMG = makeCardPath("${NAME}.png");
