...
import theExplorer.actions.defaultMod.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = ExplorerMod.makeID(DefaultUncommonPower.class.getSimpleName());
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        addToBot(new UncommonPowerAction(p, m, magicNumber,
