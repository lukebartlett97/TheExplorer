...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = ExplorerMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main ExplorerMod.java file in the
    ...
    public DefaultCommonAttack() {
        super(ID, NAME, getImage(), COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
    ...
    private static String getImage() {
        ExplorerMod.logger.info("Card Image: " + IMG);
        return IMG;
    }
