...
import theExplorer.orbs.defaultMod.DefaultOrb;
...
public class OrbSkill extends AbstractDynamicCard {
    ...
    public static final String ID = ExplorerMod.makeID(OrbSkill.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ChannelAction(new DefaultOrb())); // Channel a Default Orb.
